...
const TOUR_STEPS = [
  ...
  {
    target: '.canvas-mode-btn',
    title: 'Light mode and dark mode',
    body: 'Most apps today support both a light and a dark version. Toggle this button to preview how your style looks in each — and make sure your colors look great either way.',
    placement: 'left',
    pad: 8,
  },
  {
  ...
  {
    target: '.step-nav-item:nth-child(2)',
    title: 'Every color is accessibility-checked',
    body: 'In the Colors step, every color shows a readability score. This tells you whether text will be easy to read against that background — important for users with visual impairments. The tool automatically picks the right text color to keep everything legible.',
    placement: 'right',
    pad: 6,
  },
  {
    target: '.header-file-btn',
    title: 'Advanced: save and share your style',
    body: 'The Token template menu lets you download a blank style file to fill in manually, or import one you\'ve already set up. Handy for sharing your style with a developer or picking up where you left off on another device.',
    placement: 'bottom',
    pad: 8,
  },
  {
